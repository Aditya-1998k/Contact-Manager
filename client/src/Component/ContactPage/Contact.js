...
function Contact() {
    ...
    const handleAlldelete=(id)=>{
      axios({
        method:"POST",
        url:"http://localhost:3001/contact/alldelete",
        headers:{
        },
        data:isChecked
      }).then((res)=>{
  ...
  return (
    ...
    <div>
        ...
        <form className="d-flex" role="search">
          ...
          <button className="btn btn-info" type="submit"style={{marginLeft:"5px"}} ><span><svg style={{marginLeft:"5px"}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
